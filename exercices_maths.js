...
window.EXERCICES_MATHS = {
  ...
  {shape:"losange",svg:"<polygon points=\"40,120 140,120 200,40 100,40\" fill=\"#F0FFF4\" stroke=\"#276749\" stroke-width=\"2.5\"/>",chars:["4 côtés isométriques", "4 côtés de longueurs différentes", "Tous les côtés opposés sont isométriques", "1 seule paire de côtés parallèles", "4 angles droits"],answers:[0, 2]},
  ...
  {shape:"parallélogramme",svg:"<polygon points=\"100,15 160,65 140,145 80,95\" fill=\"#FFF5F5\" stroke=\"#9B2335\" stroke-width=\"2.5\"/>",chars:["4 côtés de longueurs différentes", "Au moins 2 angles droits", "2 angles aigus et 2 angles obtus", "2 paires de côtés parallèles", "4 côtés isométriques"],answers:[2, 3]},
  ...
  {shape:"trapèze rectangle",svg:"<polygon points=\"40,30 110,30 150,130 40,130\" fill=\"#ECFDF5\" stroke=\"#065F46\" stroke-width=\"2.5\"/>",chars:["Au moins 2 angles droits", "1 seule paire de côtés parallèles", "2 paires de côtés parallèles", "4 côtés de longueurs différentes", "4 angles droits"],answers:[0, 1]},
  {shape:"trapèze rectangle",svg:"<polygon points=\"40,30 130,30 160,130 40,130\" fill=\"#ECFDF5\" stroke=\"#065F46\" stroke-width=\"2.5\"/>",chars:["1 seule paire de côtés parallèles", "2 angles aigus et 2 angles obtus", "4 côtés de longueurs différentes", "Diagonales perpendiculaires", "Au moins 2 angles droits"],answers:[0, 2, 4]},
  ...
  {shape:"trapèze quelconque",svg:"<polygon points=\"45,40 135,40 175,120 25,120\" fill=\"#FFF7ED\" stroke=\"#9A3412\" stroke-width=\"2.5\"/>",chars:["4 côtés de longueurs différentes", "4 angles droits", "Au moins 2 angles droits", "2 paires de côtés parallèles", "Tous les côtés opposés sont isométriques"],answers:[0]},
  {shape:"trapèze quelconque",svg:"<polygon points=\"35,40 155,40 125,120 55,120\" fill=\"#FFF7ED\" stroke=\"#9A3412\" stroke-width=\"2.5\"/>",chars:["4 côtés isométriques", "Tous les côtés opposés sont isométriques", "4 côtés de longueurs différentes", "Médianes perpendiculaires", "1 seule paire de côtés parallèles"],answers:[2, 4]},
  ...
  {shape:"quadrilatère quelconque",svg:"<polygon points=\"30,30 170,40 150,130 40,110\" fill=\"#F0F4FF\" stroke=\"#3730A3\" stroke-width=\"2.5\"/>",chars:["1 seule paire de côtés parallèles", "2 paires de côtés parallèles", "4 côtés de longueurs différentes", "Au moins 2 angles droits", "Diagonales perpendiculaires"],answers:[2]}
      ]
...
window.OP_X9_BANQUE = [
  ...
  { a: 1.5, b: 9, op: '×', answer: 13.5 },
  { a: 2.5, b: 9, op: '×', answer: 22.5 },
  { a: 0.8, b: 9, op: '×', answer: 7.2 },
  { a: 3.2, b: 9, op: '×', answer: 28.8 },
  { a: 4.5, b: 9, op: '×', answer: 40.5 },
  { a: 0.12, b: 9, op: '×', answer: 1.08 },
  { a: 7.5, b: 9, op: '×', answer: 67.5 },
  { a: 0.6, b: 9, op: '×', answer: 5.4 },
  { a: 12.4, b: 9, op: '×', answer: 111.6 },
  { a: 8.5, b: 9, op: '×', answer: 76.5 },
  { a: 0.09, b: 9, op: '×', answer: 0.81 },
  { a: 1.1, b: 9, op: '×', answer: 9.9 },
  ...
  { a: 1.5, b: 90, op: '×', answer: 135 },
  { a: 2.5, b: 90, op: '×', answer: 225 },
  { a: 0.8, b: 90, op: '×', answer: 72 },
  { a: 3.4, b: 90, op: '×', answer: 306 },
  { a: 4.5, b: 90, op: '×', answer: 405 },
  { a: 0.12, b: 90, op: '×', answer: 10.8 },
  { a: 7.5, b: 90, op: '×', answer: 675 },
  { a: 0.6, b: 90, op: '×', answer: 54 },
  { a: 1.2, b: 90, op: '×', answer: 108 },
  { a: 8.5, b: 90, op: '×', answer: 765 },
  { a: 0.05, b: 90, op: '×', answer: 4.5 },
  { a: 10.5, b: 90, op: '×', answer: 945 },
  ...
  { a: 21, b: 99, op: '×', answer: 2079 },
  { a: 35, b: 99, op: '×', answer: 3465 },
  { a: 1.5, b: 99, op: '×', answer: 148.5 },
  { a: 2.5, b: 99, op: '×', answer: 247.5 },
  { a: 0.8, b: 99, op: '×', answer: 79.2 },
  { a: 0.5, b: 99, op: '×', answer: 49.5 },
  { a: 4.5, b: 99, op: '×', answer: 445.5 },
  { a: 0.2, b: 99, op: '×', answer: 19.8 },
  { a: 7.5, b: 99, op: '×', answer: 742.5 },
  { a: 0.6, b: 99, op: '×', answer: 59.4 },
  { a: 1.2, b: 99, op: '×', answer: 118.8 },
  { a: 8.5, b: 99, op: '×', answer: 841.5 },

  // --- × 9,9 (25 questions) ---
  { a: 10, b: 9.9, op: '×', answer: 99 },
  { a: 20, b: 9.9, op: '×', answer: 198 },
  { a: 30, b: 9.9, op: '×', answer: 297 },
  { a: 40, b: 9.9, op: '×', answer: 396 },
  { a: 50, b: 9.9, op: '×', answer: 495 },
  { a: 60, b: 9.9, op: '×', answer: 594 },
  { a: 70, b: 9.9, op: '×', answer: 693 },
  { a: 80, b: 9.9, op: '×', answer: 792 },
  { a: 90, b: 9.9, op: '×', answer: 891 },
  { a: 100, b: 9.9, op: '×', answer: 990 },
  ...
  { a: 1.5, b: 9.9, op: '×', answer: 14.85 },
  { a: 2.5, b: 9.9, op: '×', answer: 24.75 },
  { a: 0.5, b: 9.9, op: '×', answer: 4.95 },
  { a: 4.5, b: 9.9, op: '×', answer: 44.55 },
  { a: 0.2, b: 9.9, op: '×', answer: 1.98 },
  { a: 7.5, b: 9.9, op: '×', answer: 74.25 },
  { a: 0.6, b: 9.9, op: '×', answer: 5.94 },
  { a: 1.2, b: 9.9, op: '×', answer: 11.88 },
  { a: 8.5, b: 9.9, op: '×', answer: 84.15 },
