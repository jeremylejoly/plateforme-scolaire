...
window.EXERCICES_FRANCAIS = {
  ...
  conjugaison: {
    ...
    futur: {
      ...
      qcm_bank: [
        {text:"Demain, je ___ (aller) chez le médecin.", options:["allerai", "irai", "irais"], answer:1},
        {text:"L'année prochaine, tu ___ (avoir) douze ans.", options:["aurais", "auras", "avoiras"], answer:1},
        {text:"Ce soir, il ___ (être) en retard.", options:["serat", "serait", "sera"], answer:2},
        {text:"Nous ___ (faire) un gâteau pour l'anniversaire.", options:["ferrons", "ferons", "fairons"], answer:1},
        {text:"Vous ___ (venir) nous rendre visite dimanche.", options:["viendrez", "venirez", "viendriez"], answer:0},
        {text:"Ils ___ (pouvoir) partir dès demain.", options:["pourront", "pouveront", "pourraient"], answer:0},
        {text:"Elle ___ (vouloir) sûrement un cadeau.", options:["vouloira", "voudra", "voudrait"], answer:1},
        ...
        {text:"Il ___ (venir) nous aider demain matin.", options:["viendrait", "venira", "viendra"], answer:2},
        {text:"Nous ___ (devoir) travailler plus dur.", options:["devrons", "devoirons", "devoirerons"], answer:0},
        {text:"Vous ___ (savoir) la vérité bientôt.", options:["sauriez", "saurez", "savoirez"], answer:1},
        {text:"Elles ___ (tenir) leur promesse.", options:["teniront", "tiendriont", "tiendront"], answer:2},
        {text:"Je ___ (recevoir) mon cadeau demain.", options:["recevrais", "recevoirai", "recevrai"], answer:2},
        {text:"Tu ___ (mourir) de rire en voyant ça !", options:["mouriras", "mourras", "mourriras"], answer:1},
        {text:"Il ___ (courir) le marathon l'an prochain.", options:["courra", "courirait", "courera"], answer:0},
        {text:"Nous ___ (envoyer) une lettre à nos grands-parents.", options:["envoyerons", "enverrons", "envoierons"], answer:1},
        {text:"Vous ___ (appeler) le médecin si nécessaire.", options:["appèlerez", "appelerez", "appellerez"], answer:2},
        {text:"Elles ___ (jeter) leurs vieux jouets.", options:["jeteront", "jèteront", "jetteront"], answer:2},
        {text:"Je ___ (acheter) du pain ce soir.", options:["achèterai", "achetterai", "achètterai"], answer:0},
        {text:"Tu ___ (se lever) tôt demain matin.", options:["te levereas", "te levras", "te lèveras"], answer:2},
        {text:"Il ___ (falloir) travailler davantage.", options:["falloira", "faudrait", "faudra"], answer:2},
        {text:"Nous ___ (valoir) mieux que ça !", options:["vaudriont", "valerons", "vaudrons"], answer:2},
        {text:"Vous ___ (cueillir) des fruits dans le jardin.", options:["cueillrez", "cueillirez", "cueillerez"], answer:2},
        ...
        {text:"Il ___ (pleuvoir) demain selon la météo.", options:["pleuvra", "pleuvroira", "pleuvera"], answer:0},
        {text:"Grâce à la météo, les plantes ___ (grandir) vite.", options:["grandisseront", "grandiront", "grandirront"], answer:1},
        {text:"Vous me ___ (dire) la vérité.", options:["direrez", "direz", "diterez"], answer:1},
        {text:"Elles ___ (fuir) si elles ont peur.", options:["fuirront", "fuieront", "fuiront"], answer:2},
        {text:"Je ___ (haïr) attendre, mais je patienterai.", options:["hairai", "haierat", "haïrai"], answer:2},
        {text:"Tu ___ (bouillir) d'impatience en attendant les résultats.", options:["bouiliras", "bouilliras", "bouillirais"], answer:1},
        {text:"Il ___ (dormir) mieux après cette journée.", options:["dormerat", "dormirait", "dormira"], answer:2},
        {text:"Nous ne ___ (mentir) pas — nous dirons la vérité.", options:["mentirions", "mentironts", "mentirons"], answer:2},
        {text:"Vous ___ (partir) en vacances la semaine prochaine.", options:["partiriez", "partirerez", "partirez"], answer:2},
        {text:"Elles ___ (sentir) bon après ce bain de fleurs.", options:["sentironts", "sentiront", "sentiraient"], answer:1},
        {text:"Je ___ (sortir) dès que j'aurai fini.", options:["sortirais", "sortirai", "sortirrai"], answer:1},
        {text:"Tu ___ (servir) les invités avec plaisir.", options:["serviras", "servireras", "servirais"], answer:0},
        {text:"Il ___ (ouvrir) la fenêtre pour aérer.", options:["ouvrira", "ouvrera", "ouvrirait"], answer:0},
        {text:"Nous ___ (offrir) un cadeau à notre professeur.", options:["offririons", "offrirons", "offrironts"], answer:1},
        {text:"Vous ___ (souffrir) moins avec ce médicament.", options:["souffrirerez", "souffririez", "souffrirez"], answer:2},
        {text:"Elles ___ (coudre) les costumes pour le spectacle.", options:["coudreront", "couderont", "coudront"], answer:2},
        {text:"Je ___ (conduire) prudemment sur cette route.", options:["conduirais", "conduirai", "conduierat"], answer:1},
        {text:"Tu ___ (écrire) une lettre à ton correspondant.", options:["écriras", "écrieras", "écrirait"], answer:0},
        {text:"Il ___ (lire) ce livre en une journée.", options:["lirerat", "lira", "lirait"], answer:1},
        {text:"Nous ___ (rire) bien en regardant ce film.", options:["rirons", "rirrons", "rirerons"], answer:0},
      ...
      qcm_bank: [
        ...
        {text:"Nous ___ les assiettes sur la table.", options:["placeons", "plaçons", "plaçeons"], answer:1},
        {text:"Nous ___ des pâtes ce soir.", options:["mangons", "mangeons", "manjons"], answer:1},
        ...
        {text:"Elle ___ ses amis pour son anniversaire.", options:["appele", "appèle", "appelle"], answer:2},
        {text:"Je ___ la balle trop loin.", options:["jete", "jette", "jète"], answer:1},
        {text:"Tu ___ doucement ton ami.", options:["rappèles", "rappelles", "rapèles"], answer:1},
        ...
        {text:"Je ___ doucement la boîte.", options:["souleve", "soullève", "soulève"], answer:2},
        {text:"Nous ___ contents de te voir.", options:["sommes", "somme", "sommons"], answer:0},
        {text:"Il ___ un grand frère très gentil.", options:["ont", "a", "as"], answer:1},
        {text:"Vous ___ en retard aujourd'hui.", options:["ètes", "êtez", "êtes"], answer:2},
        {text:"Elles ___ beaucoup de courage.", options:["avent", "ont", "sont"], answer:1},
        {text:"Nous ___ en voiture ce matin.", options:["viendons", "venions", "venons"], answer:2},
        {text:"Tu ___ très vite !", options:["coures", "cours", "courres"], answer:1},
        {text:"Ils ___ à minuit.", options:["partirent", "partes", "partent"], answer:2},
        {text:"Elle ___ la porte doucement.", options:["ouvrit", "ouvres", "ouvre"], answer:2},
        {text:"Vous ___ bien cette nuit.", options:["dormiez", "dormissez", "dormez"], answer:2},
        {text:"Il ___ un cadeau à sa maman.", options:["offrit", "offre", "offres"], answer:1},
        {text:"Nous ___ à nos promesses.", options:["tenons", "tiendons", "teneons"], answer:0},
        {text:"Vous ne ___ pas la vérité.", options:["disez", "ditez", "dites"], answer:2},
        {text:"Nous ___ nos devoirs.", options:["faisons", "faiseons", "fesons"], answer:0},
        {text:"Il ___ un livre passionnant.", options:["lit", "lise", "lite"], answer:0},
        {text:"Tu ___ une lettre à ta mamie.", options:["écris", "écrit", "écrits"], answer:0},
        {text:"Ils ___ le problème ensemble.", options:["prenent", "prendent", "prennent"], answer:2},
        {text:"Elle ___ ses affaires dans sa chambre.", options:["mets", "mette", "met"], answer:2},
        {text:"Nous ___ en France.", options:["vivez", "vivons", "viveons"], answer:1},
        {text:"Je ___ un beau film ce soir.", options:["voit", "vois", "voie"], answer:1},
        {text:"Ils ___ partir tôt demain.", options:["doivont", "doivent", "devoient"], answer:1},
        {text:"Tu ___ la réponse !", options:["saies", "sait", "sais"], answer:2},
        {text:"Nous ___ finir ce travail.", options:["pouveons", "pouvons", "pouvez"], answer:1},
        {text:"Elle ___ un colis ce matin.", options:["recoit", "reçoie", "reçoit"], answer:2},
        {text:"Vous ___ aller au cinéma.", options:["vouliez", "voulissez", "voulez"], answer:2},
        {text:"Il ___ son chemin dans la forêt.", options:["voie", "voits", "voit"], answer:2},
        {text:"Nous ___ nos leçons chaque soir.", options:["savons", "savez", "saveons"], answer:0},
        {text:"Vous ne ___ jamais ce qu'il raconte.", options:["croivez", "croiez", "croyez"], answer:2},
      ...
      evaluation: {
        qcm: [
          {text:"Je ___ la balle trop loin.", options:["jete", "jète", "jette"], answer:2},
          {text:"Il ___ un grand frère très gentil.", options:["ont", "a", "as"], answer:1},
          {text:"Tu ___ très vite !", options:["coures", "courres", "cours"], answer:2},
          {text:"Nous ___ la leçon depuis le début.", options:["recommençons", "recommenceons", "recomençons"], answer:0},
          {text:"Elle ___ un colis ce matin.", options:["reçoit", "reçoie", "recoit"], answer:0},
        ],
        trous: [
          {before:"Ma sœur ", after:" le sol de la cuisine.", verb:"essuyer (elle)", answer:"essuie"},
          {before:"Nous ", after:" notre voyage demain.", verb:"commencer (nous)", answer:"commençons"},
    ...
    ,imparfait: {
      ...
      qcm_bank: [
        ...
        {text:"Il ___ des fruits au marché.", options:["achetait", "achettait", "achètait"], answer:0},
    ...
    ,passe_compose: {
      qcm_bank: [
        ...
        {text:"Tu ___ (jeter) tes vieux cahiers à la fin de l'année.", options:["as jetté", "as jeter", "as jeté"], answer:2},
        {text:"Il ___ (appeler) ses parents dès son arrivée.", options:["as appelé", "a appellé", "a appelé"], answer:2},
        {text:"Nous ___ (emmener) les enfants au parc ce matin.", options:["sommes emmenés", "avons emmenés", "avons emmené"], answer:2},
        {text:"Elle ___ (lever) la main pour répondre à la question.", options:["as levé", "a levé", "a levée"], answer:1},
        {text:"Vous ___ (envoyer) le colis hier matin.", options:["êtes envoyé", "avez envoié", "avez envoyé"], answer:2},
        {text:"Tu ___ (essuyer) la vaisselle après le repas.", options:["a essuyé", "as essuié", "as essuyé"], answer:2},
        {text:"Il ___ (guérir) rapidement grâce aux médicaments.", options:["a guérit", "a guérie", "a guéri"], answer:2},
        {text:"Je ___ (lire) ce roman en une seule journée.", options:["ai lus", "ai lut", "ai lu"], answer:2},
        {text:"Nous ___ (écrire) une lettre à notre correspondant.", options:["avons écri", "avons écris", "avons écrit"], answer:2},
        {text:"Elle ___ (mettre) son manteau avant de sortir.", options:["a mis", "a mi", "a mit"], answer:0},
        {text:"Tu ___ (dire) la vérité à tes parents.", options:["as di", "as dis", "as dit"], answer:2},
        {text:"Ils ___ (faire) une randonnée en montagne ce week-end.", options:["ont faient", "ont fait", "ont fais"], answer:1},
        {text:"J' ___ (boire) un grand verre d'eau après le sport.", options:["ai bu", "ai but", "ai bus"], answer:0},
        {text:"Elle ___ (peindre) un magnifique tableau pour l'exposition.", options:["a pein", "a peint", "a peind"], answer:1},
        {text:"Nous ___ (mentir) et nous le regrettons.", options:["avons mentit", "avons mentis", "avons menti"], answer:2},
        {text:"Il ___ (tenir) sa promesse jusqu'au bout.", options:["a tenu", "a tenus", "a tenut"], answer:0},
        {text:"Le directeur ___ (accueillir) les nouveaux élèves ce matin.", options:["a accueillut", "a accueillit", "a accueilli"], answer:2},
        {text:"Je ___ (vouloir) lui dire la vérité mais je n'ai pas osé.", options:["ai voulu", "ai voulut", "ai voulus"], answer:0},
        {text:"Nous ___ (aller) au cinéma vendredi soir.", options:["sommes allé", "sommes aller", "sommes allés"], answer:2},
        {text:"Tu ___ (recevoir) un beau cadeau pour ton anniversaire.", options:["as reçu", "as reçut", "as reçus"], answer:0},
        {text:"Elle ___ (revenir) de vacances hier soir.", options:["est revenue", "est revenut", "est revenu"], answer:0},
        {text:"Vous ___ (devoir) travailler très dur pour réussir.", options:["avez dû", "avez dut", "avez du"], answer:0},
        {text:"Il ___ (voir) un film magnifique au cinéma.", options:["a vus", "a vu", "a vut"], answer:1},
        {text:"Il ___ (falloir) partir très tôt ce matin.", options:["a fallut", "a fallue", "a fallu"], answer:2},
        {text:"Elle ___ (résoudre) ce problème difficile en cinq minutes.", options:["a résolut", "a résolue", "a résolu"], answer:2},
        {text:"Tu ___ (rejoindre) tes amis au parc après l'école.", options:["as rejoint", "as rejoind", "as rejoins"], answer:0},
        {text:"Il ___ (amener) son chien chez le vétérinaire hier.", options:["a amenés", "a amené", "a amener"], answer:1},
        {text:"Elle ___ (craindre) le pire mais tout s'est bien passé.", options:["a craint", "a crainte", "a craind"], answer:0},
        {text:"Je ___ (courir) dix kilomètres ce matin.", options:["ai couru", "ai courrus", "ai courri"], answer:0},
        {text:"Tu ___ (venir) nous rendre visite la semaine dernière.", options:["es venus", "es venut", "es venu(e)"], answer:2},
        {text:"Cette plante ___ (mourir) faute d'eau pendant les vacances.", options:["est mort", "est mourru", "est morte"], answer:2},
        {text:"Grand-mère ___ (coudre) les costumes pour le spectacle.", options:["a cousut", "a cousu", "a cousue"], answer:1},
        {text:"Il ___ (vivre) dix ans en Australie avant de rentrer.", options:["a vécut", "a vit", "a vécu"], answer:2},
        {text:"Tu ___ (conduire) prudemment sur cette route dangereuse.", options:["as condui", "as conduit", "as conduis"], answer:1},
...
window.DIAL_ARMSTRONG_DATA = {
  id: 'armstrong',
  titre: 'Un grand pas pour l\'humanité',
  sousTitre: '🚀 Interview fictive — Neil Armstrong raconte la mission Apollo 11',
  contexte: 'Le 20 juillet 1969, l\'astronaute américain Neil Armstrong devient le premier homme à marcher sur la Lune. Quelques mois après son retour sur Terre, il répond aux questions d\'une journaliste lors d\'une émission de télévision spéciale.',
  intervenants: ['La Journaliste', 'Neil Armstrong'],
  couleur: '#0277bd',
  repliques: [
    ...
    {qui:'Neil Armstrong', texte:'J\'y ai réfléchi après nous être posés, pendant la préparation de la sortie. Je voulais exprimer simplement que ce succès n\'était pas le mien seul, mais le fruit du travail de plus de 400 000 ingénieurs, techniciens et ouvriers.'},
    {qui:'La Journaliste', texte:'À quoi ressemble la Terre vue depuis la surface de la Lune ?', didascalie:'émue'},
    {qui:'Neil Armstrong', texte:'C\'est une bille bleue et blanche, minuscule et lumineuse, perdue au milieu d\'une obscurité infinie. On prend soudain conscience de son incroyable fragilité et du fait que toute l\'histoire humaine repose sur ce petit point dans l\'espace.', didascalie:'pensif'},
    {qui:'La Journaliste', texte:'Un témoignage inoubliable... Merci infiniment Neil Armstrong d\'avoir partagé ces souvenirs extraordinaires avec nous !', didascalie:'chaleureusement'},
    {qui:'Neil Armstrong', texte:'Merci à vous. L\'aventure spatiale ne fait que commencer !', didascalie:'avec un sourire confiant'},
  ],
  qcm:[
    {q:'En quelle année Neil Armstrong a-t-il posé le pied sur la Lune ?',
     opts:['En 1959','En 1969','En 1979','En 1989'],
     correct:1, explication:'La mission Apollo 11 a eu lieu en juillet 1969.'},
    {q:'Pourquoi Neil Armstrong a-t-il dû reprendre les commandes manuelles du module Eagle ?',
     opts:['Pour aller plus vite','Parce que les moteurs s\'étaient arrêtés','Parce que le pilote automatique se dirigeait vers des rochers dangereux','Pour revenir directement sur Terre'],
     correct:2, explication:'Le pilote automatique guidait le module vers un cratère rempli de gros rochers menaçant l\'alunissage.'},
    {q:'Combien de carburant restait-il au moment où le module a enfin atterri ?',
     opts:['Plusieurs heures','Une trentaine de secondes de réserve','Le réservoir était à moitié plein','Il n\'y avait plus du tout de carburant'],
     correct:1, explication:'Neil Armstrong explique qu\'il ne restait qu\'une trentaine de secondes de carburant avant la panne sèche.'},
    {q:'Que souhaite rappeler Neil Armstrong à propos de sa célèbre phrase ?',
     opts:['Qu\'il voulait devenir célèbre','Que cet exploit est le résultat du travail de 400 000 personnes','Qu\'il avait inventé cette phrase à l\'école','Que la mission était trop facile'],
     correct:1, explication:'Il rappelle avec humilité que ce bond de géant est l\'effort collectif de plus de 400 000 personnes.'},
  ],
  attribution:[
    {texte:'"Il n\'y avait pas de place pour la peur : chaque seconde et chaque geste avaient été répétés..."', correct:1},
    {texte:'"Le monde entier a retenu son souffle en juillet 1969..."', correct:0},
    {texte:'"On prend soudain conscience de son incroyable fragilité..."', correct:1},
    {texte:'"À quoi ressemble la Terre vue depuis la surface de la Lune ?"', correct:0},
    {texte:'"L\'aventure spatiale ne fait que commencer !"', correct:1},
  ],
  intentions:[
    {replique:'"Pourtant, l\'alunissage du module Eagle ne s\'est pas déroulé exactement comme prévu..."',
     opts:['Piéger l\'astronaute avec une question accusatrice','Relancer la discussion sur un moment critique et palpitant','Montrer qu\'elle n\'a rien compris au vol','Interrompre l\'invité pour parler d\'autre chose'],
     correct:1, explication:'La journaliste amène l\'invité à raconter l\'imprévu technique le plus palpitant de la mission.'},
    {replique:'"Je voulais exprimer simplement que ce succès n\'était pas le mien seul..."',
     opts:['Faire preuve d\'humilité et saluer le travail de toute la communauté scientifique','Se dédouaner d\'une erreur de pilotage','Critiquer ses collègues astronautes','Éviter de répondre à la question'],
     correct:0, explication:'Neil Armstrong met en valeur l\'effort collectif colossal des équipes de la NASA.'},
    {replique:'"On prend soudain conscience de son incroyable fragilité..."',
     opts:['Exprimer une peur panique de ne pas pouvoir rentrer','Partager une prise de conscience émouvante sur la planète Terre','Donner un cours de géologie lunaire','Se plaindre des températures dans l\'espace'],
     correct:1, explication:'Il partage sa réflexion philosophique et son émotion en contemplant la Terre depuis la Lune.'},
    {replique:'"Merci infiniment Neil Armstrong d\'avoir partagé ces souvenirs extraordinaires avec nous !"',
     opts:['Conclure l\'interview avec politesse et gratitude','Demander un autographe pour ses enfants','Exprimer son désaccord avec l\'invité','Signaler que l\'émission est en retard'],
     correct:0, explication:'La journaliste clôt l\'entretien en remerciant chaleureusement son invité d\'honneur.'},
  ],
};

window.DIAL_CONSEIL_DATA = {
  id: 'conseil',
  titre: 'Le grand désaccord',
  sousTitre: '🎭 Scène de théâtre — Conseil de classe et projet de fin d\'année',
  contexte: 'En fin de journée dans la classe de M. Dumont. Les élèves délégués sont réunis pour choisir l\'activité de la sortie scolaire annuelle. Le budget de 400 € ne permet de financer qu\'un seul projet. Chacun arrive avec son idée arrêtée...',
  intervenants: ['M. Dumont', 'Léa', 'Maxime', 'Sofia'],
  couleur: '#7b1fa2',
  repliques: [
    {qui:'didascalie', texte:'Dans la classe vide après la sonnerie. M. Dumont est assis au centre d\'une table ronde avec ses trois élèves délégués.'},
    {qui:'M. Dumont', texte:'Bien, chers délégués. Grâce aux ventes de crêpes, nous disposons de 400 euros pour notre projet de fin d\'année. Nous devons voter pour une proposition commune. Qui prend la parole en premier ?', didascalie:'d\'un ton calme et encourageant'},
    {qui:'Léa', texte:'Moi ! Il faut absolument aller au parc d\'accrobranche ! Après des mois enfermés en classe, tout le monde rêve de courir, de grimper et de vivre une grande aventure dans les arbres !', didascalie:'très enthousiaste, les yeux brillants'},
    {qui:'Maxime', texte:'Pas d\'accord du tout ! Tu oublies tous ceux qui ont le vertige, Léa ! Moi, je propose une journée au musée des sciences avec des ateliers de programmation robotique. C\'est passionnant, moderne et tout le monde peut participer !', didascalie:'croisant les bras d\'un air décidé'},
    {qui:'Sofia', texte:'Mais vous passez à côté de la meilleure idée : faire venir une troupe de comédiens pour écrire et jouer une pièce de théâtre tous ensemble ! On fabriquerait les décors et les costumes ! C\'est un souvenir inoubliable !', didascalie:'se levant avec passion'},
    {qui:'Léa', texte:'Encore du théâtre ? Mais on passe déjà l\'année assis à écouter ! On veut de l\'action et du grand air !', didascalie:'haussant le ton'},
    {qui:'Maxime', texte:'Et toi Léa, tu ne penses qu\'à l\'effort physique ! Tout le monde n\'est pas un grand sportif !', didascalie:'agacé'},
    {qui:'M. Dumont', texte:'Holà, du calme tous les trois ! Un conseil de classe n\'est pas une foire d\'empoigne. Avez-vous remarqué que chacune de vos propositions est pleine de qualités ?', didascalie:'levant les mains pour apaiser les débats'},
    {qui:'Sofia', texte:'Oui... mais avec 400 euros, nous ne pouvons pas tout payer séparément.', didascalie:'baissant la voix'},
    {qui:'M. Dumont', texte:'Exactement. Alors au lieu de vous opposer, cherchez comment réunir le meilleur de vos trois idées dans un compromis.'},
    {qui:'Maxime', texte:'Attendez... et si nous allions au grand domaine naturel de la forêt voisine ? Le matin, un jeu de piste scientifique sur la biodiversité avec des énigmes, et l\'après-midi, un grand jeu de rôle théâtral grandeur nature en plein air !', didascalie:'souriant, illuminé par son idée'},
    {qui:'Léa', texte:'Oh génial ! Du sport, de la nature, des défis et du jeu ! J\'adore !', didascalie:'tapant dans ses mains'},
    {qui:'Sofia', texte:'Et ça entre pile dans notre budget de 400 euros avec le bus !', didascalie:'radieuse'},
    {qui:'M. Dumont', texte:'Magnifique ! Vous voyez : quand on s\'écoute au lieu de crier, un grand désaccord se transforme en une superbe victoire d\'équipe.', didascalie:'félicitant chaleureusement ses élèves'},
    {qui:'didascalie', texte:'Les trois délégués se congratulent avec le sourire, fiers de leur compromis.'},
  ],
  qcm:[
    {q:'Quelle est la somme disponible pour le projet de fin d\'année ?',
     opts:['100 euros','200 euros','400 euros','1 000 euros'],
     correct:2, explication:'M. Dumont rappelle qu\'ils ont récolté 400 euros grâce à la vente de crêpes.'},
    {q:'Quelle activité Léa défend-elle ardemment ?',
     opts:['Une sortie au cinéma','Une journée au parc d\'accrobranche','Une visite de château fort','Un atelier de dessin'],
     correct:1, explication:'Léa propose d\'aller à l\'accrobranche pour faire de l\'exercice et profiter du grand air.'},
    {q:'Quel argument Maxime oppose-t-il à la proposition de Léa ?',
     opts:['L\'accrobranche est trop cher','Le parc est trop loin de l\'école','Certains élèves souffrent de vertige et ne pourraient pas en profiter','Les professeurs ne veulent pas y aller'],
     correct:2, explication:'Maxime souligne à juste titre que l\'accrobranche exclut les camarades sujets au vertige.'},
    {q:'Quel compromis final les délégués adoptent-ils ?',
     opts:['Annuler la sortie','Tirer au sort une des activités','Une journée en domaine naturel avec énigmes scientifiques et jeu de rôle théâtral','Aller uniquement au musée des sciences'],
     correct:2, explication:'Ils combinent nature, science et théâtre en une journée de jeu de piste et jeu de rôle en forêt.'},
  ],
  attribution:[
    {texte:'"Il faut absolument aller au parc d\'accrobranche ! Après des mois enfermés en classe..."', correct:1},
    {texte:'"Un conseil de classe n\'est pas une foire d\'empoigne."', correct:0},
    {texte:'"Tu oublies tous ceux qui ont le vertige, Léa !"', correct:2},
    {texte:'"On fabriquerait les décors et les costumes ! C\'est un souvenir inoubliable !"', correct:3},
    {texte:'"Quand on s\'écoute au lieu de crier, un grand désaccord se transforme en une superbe victoire..."', correct:0},
  ],
  intentions:[
    ...
    {replique:'"Attendez... et si nous allions au grand domaine naturel de la forêt voisine ? Le matin, un jeu de piste..."',
     opts:['Imposer une quatrième idée sans concertation','Rejeter le conseil de classe','Proposer une synthèse constructive intégrant les souhaits de chacun','Refuser de participer au vote'],
     correct:2, explication:'Maxime formule une solution hybride très astucieuse qui réunit le sport, la science et le théâtre.'},
    {replique:'"Magnifique ! Vous voyez : quand on s\'écoute au lieu de crier, un grand désaccord se transforme en une superbe victoire d\'équipe."',
     opts:['Valoriser la réussite du dialogue démocratique et l\'esprit de coopération','Regretter le temps passé à négocier','Se féliciter d\'avoir lui-même choisi la destination','Reporter la décision finale'],
     correct:0, explication:'L\'enseignant conclut par un enseignement moral et civique positif sur les vertus de l\'écoute et de l\'entente.'},
  ],
};

if(window.DIALOGUES_DATA) {
  window.DIALOGUES_DATA.armstrong = window.DIAL_ARMSTRONG_DATA;
  window.DIALOGUES_DATA.conseil = window.DIAL_CONSEIL_DATA;
  window.DIALOGUES_DATA.marche = window.DIAL_MARCHE_DATA;
}
...
window.EXERCICES_NOM_RECONNAITRE = [
  // 90 NOMS COMMUNS (45%)
  { word: "chat", cat: "nc", label: "un nom commun" },
  { word: "maison", cat: "nc", label: "un nom commun" },
  { word: "école", cat: "nc", label: "un nom commun" },
  { word: "arbre", cat: "nc", label: "un nom commun" },
  { word: "livre", cat: "nc", label: "un nom commun" },
  { word: "table", cat: "nc", label: "un nom commun" },
  { word: "chaise", cat: "nc", label: "un nom commun" },
  { word: "stylo", cat: "nc", label: "un nom commun" },
  { word: "chien", cat: "nc", label: "un nom commun" },
  { word: "fleur", cat: "nc", label: "un nom commun" },
  { word: "voiture", cat: "nc", label: "un nom commun" },
  { word: "ordinateur", cat: "nc", label: "un nom commun" },
  { word: "fenêtre", cat: "nc", label: "un nom commun" },
  { word: "porte", cat: "nc", label: "un nom commun" },
  { word: "route", cat: "nc", label: "un nom commun" },
  { word: "soleil", cat: "nc", label: "un nom commun" },
  { word: "lune", cat: "nc", label: "un nom commun" },
  { word: "étoile", cat: "nc", label: "un nom commun" },
  { word: "ciel", cat: "nc", label: "un nom commun" },
  { word: "nuage", cat: "nc", label: "un nom commun" },
  { word: "vent", cat: "nc", label: "un nom commun" },
  { word: "pluie", cat: "nc", label: "un nom commun" },
  { word: "neige", cat: "nc", label: "un nom commun" },
  { word: "fleuve", cat: "nc", label: "un nom commun" },
  { word: "lac", cat: "nc", label: "un nom commun" },
  { word: "forêt", cat: "nc", label: "un nom commun" },
  { word: "montagne", cat: "nc", label: "un nom commun" },
  { word: "colline", cat: "nc", label: "un nom commun" },
  { word: "oiseau", cat: "nc", label: "un nom commun" },
  { word: "poisson", cat: "nc", label: "un nom commun" },
  { word: "cheval", cat: "nc", label: "un nom commun" },
  { word: "lion", cat: "nc", label: "un nom commun" },
  { word: "vache", cat: "nc", label: "un nom commun" },
  { word: "lapin", cat: "nc", label: "un nom commun" },
  { word: "jardin", cat: "nc", label: "un nom commun" },
  { word: "fruit", cat: "nc", label: "un nom commun" },
  { word: "légume", cat: "nc", label: "un nom commun" },
  { word: "pomme", cat: "nc", label: "un nom commun" },
  { word: "pain", cat: "nc", label: "un nom commun" },
  { word: "beurre", cat: "nc", label: "un nom commun" },
  { word: "lait", cat: "nc", label: "un nom commun" },
  { word: "café", cat: "nc", label: "un nom commun" },
  { word: "sucre", cat: "nc", label: "un nom commun" },
  { word: "sel", cat: "nc", label: "un nom commun" },
  { word: "assiette", cat: "nc", label: "un nom commun" },
  { word: "verre", cat: "nc", label: "un nom commun" },
  { word: "fourchette", cat: "nc", label: "un nom commun" },
  { word: "couteau", cat: "nc", label: "un nom commun" },
  { word: "cuillère", cat: "nc", label: "un nom commun" },
  { word: "lit", cat: "nc", label: "un nom commun" },
  { word: "armoire", cat: "nc", label: "un nom commun" },
  { word: "tapis", cat: "nc", label: "un nom commun" },
  { word: "rideau", cat: "nc", label: "un nom commun" },
  { word: "sac", cat: "nc", label: "un nom commun" },
  { word: "clé", cat: "nc", label: "un nom commun" },
  { word: "montre", cat: "nc", label: "un nom commun" },
  { word: "téléphone", cat: "nc", label: "un nom commun" },
  { word: "journal", cat: "nc", label: "un nom commun" },
  { word: "cahier", cat: "nc", label: "un nom commun" },
  { word: "crayon", cat: "nc", label: "un nom commun" },
  { word: "règle", cat: "nc", label: "un nom commun" },
  { word: "gomme", cat: "nc", label: "un nom commun" },
  { word: "cartable", cat: "nc", label: "un nom commun" },
  { word: "classe", cat: "nc", label: "un nom commun" },
  { word: "cour", cat: "nc", label: "un nom commun" },
  { word: "tableau", cat: "nc", label: "un nom commun" },
  { word: "craie", cat: "nc", label: "un nom commun" },
  { word: "jeu", cat: "nc", label: "un nom commun" },
  { word: "ballon", cat: "nc", label: "un nom commun" },
  { word: "poupée", cat: "nc", label: "un nom commun" },
  { word: "train", cat: "nc", label: "un nom commun" },
  { word: "avion", cat: "nc", label: "un nom commun" },
  { word: "bateau", cat: "nc", label: "un nom commun" },
  { word: "vélo", cat: "nc", label: "un nom commun" },
  { word: "chemin", cat: "nc", label: "un nom commun" },
  { word: "pont", cat: "nc", label: "un nom commun" },
  { word: "mur", cat: "nc", label: "un nom commun" },
  { word: "toit", cat: "nc", label: "un nom commun" },
  { word: "brique", cat: "nc", label: "un nom commun" },
  { word: "pierre", cat: "nc", label: "un nom commun" },
  { word: "sable", cat: "nc", label: "un nom commun" },
  { word: "terre", cat: "nc", label: "un nom commun" },
  { word: "herbe", cat: "nc", label: "un nom commun" },
  { word: "feuille", cat: "nc", label: "un nom commun" },
  { word: "branche", cat: "nc", label: "un nom commun" },
  { word: "racine", cat: "nc", label: "un nom commun" },
  { word: "graine", cat: "nc", label: "un nom commun" },
  { word: "pétale", cat: "nc", label: "un nom commun" },
  { word: "oignon", cat: "nc", label: "un nom commun" },
  { word: "tomate", cat: "nc", label: "un nom commun" },

  // 20 NOMS PROPRES (10%)
  { word: "Paris", cat: "np", label: "un nom propre" },
  { word: "Marie", cat: "np", label: "un nom propre" },
  { word: "Thomas", cat: "np", label: "un nom propre" },
  { word: "Belgique", cat: "np", label: "un nom propre" },
  { word: "France", cat: "np", label: "un nom propre" },
  { word: "Europe", cat: "np", label: "un nom propre" },
  { word: "Bruxelles", cat: "np", label: "un nom propre" },
  { word: "Meuse", cat: "np", label: "un nom propre" },
  { word: "Italie", cat: "np", label: "un nom propre" },
  { word: "Canada", cat: "np", label: "un nom propre" },
  { word: "Afrique", cat: "np", label: "un nom propre" },
  { word: "Asie", cat: "np", label: "un nom propre" },
  { word: "Londres", cat: "np", label: "un nom propre" },
  { word: "Lucas", cat: "np", label: "un nom propre" },
  { word: "Emma", cat: "np", label: "un nom propre" },
  { word: "Sarah", cat: "np", label: "un nom propre" },
  { word: "Julie", cat: "np", label: "un nom propre" },
  { word: "Antoine", cat: "np", label: "un nom propre" },
  { word: "Louise", cat: "np", label: "un nom propre" },
  { word: "Victor", cat: "np", label: "un nom propre" },

  // 20 VERBES (10%)
  { word: "chanter", cat: "v", label: "un verbe" },
  { word: "courir", cat: "v", label: "un verbe" },
  { word: "grandit", cat: "v", label: "un verbe" },
  { word: "joue", cat: "v", label: "un verbe" },
  { word: "mangent", cat: "v", label: "un verbe" },
  { word: "finir", cat: "v", label: "un verbe" },
  { word: "choisira", cat: "v", label: "un verbe" },
  { word: "rougir", cat: "v", label: "un verbe" },
  { word: "obéir", cat: "v", label: "un verbe" },
  { word: "prend", cat: "v", label: "un verbe" },
  { word: "faire", cat: "v", label: "un verbe" },
  { word: "dire", cat: "v", label: "un verbe" },
  { word: "écrivait", cat: "v", label: "un verbe" },
  { word: "lire", cat: "v", label: "un verbe" },
  { word: "voir", cat: "v", label: "un verbe" },
  { word: "vouloir", cat: "v", label: "un verbe" },
  { word: "descend", cat: "v", label: "un verbe" },
  { word: "volent", cat: "v", label: "un verbe" },
  { word: "prépare", cat: "v", label: "un verbe" },
  { word: "dort", cat: "v", label: "un verbe" },

  // 20 DETERMINANTS & PRONOMS (10%)
  { word: "le", cat: "det", label: "un déterminant" },
  { word: "une", cat: "det", label: "un déterminant" },
  { word: "il", cat: "pr", label: "un pronom" },
  { word: "nous", cat: "pr", label: "un pronom" },
  { word: "ces", cat: "det", label: "un déterminant" },
  { word: "mon", cat: "det", label: "un déterminant" },
  { word: "ton", cat: "det", label: "un déterminant" },
  { word: "ses", cat: "det", label: "un déterminant" },
  { word: "cette", cat: "det", label: "un déterminant" },
  { word: "ils", cat: "pr", label: "un pronom" },
  { word: "elle", cat: "pr", label: "un pronom" },
  { word: "je", cat: "pr", label: "un pronom" },
  { word: "tu", cat: "pr", label: "un pronom" },
  { word: "vous", cat: "pr", label: "un pronom" },
  { word: "un", cat: "det", label: "un déterminant" },
  { word: "des", cat: "det", label: "un déterminant" },
  { word: "notre", cat: "det", label: "un déterminant" },
  { word: "votre", cat: "det", label: "un déterminant" },
  { word: "leur", cat: "det", label: "un déterminant" },
  { word: "qui", cat: "pr", label: "un pronom" },

  // 30 ADJECTIFS (15%)
  { word: "grand", cat: "adj", label: "un adjectif" },
  { word: "rouge", cat: "adj", label: "un adjectif" },
  { word: "joyeux", cat: "adj", label: "un adjectif" },
  { word: "rapide", cat: "adj", label: "un adjectif" },
  { word: "petit", cat: "adj", label: "un adjectif" },
  { word: "bleu", cat: "adj", label: "un adjectif" },
  { word: "vert", cat: "adj", label: "un adjectif" },
  { word: "jaune", cat: "adj", label: "un adjectif" },
  { word: "noir", cat: "adj", label: "un adjectif" },
  { word: "blanc", cat: "adj", label: "un adjectif" },
  { word: "gris", cat: "adj", label: "un adjectif" },
  { word: "rose", cat: "adj", label: "un adjectif" },
  { word: "orange", cat: "adj", label: "un adjectif" },
  { word: "violet", cat: "adj", label: "un adjectif" },
  { word: "intelligent", cat: "adj", label: "un adjectif" },
  { word: "courageux", cat: "adj", label: "un adjectif" },
  { word: "gentil", cat: "adj", label: "un adjectif" },
  { word: "méchant", cat: "adj", label: "un adjectif" },
  { word: "beau", cat: "adj", label: "un adjectif" },
  { word: "joli", cat: "adj", label: "un adjectif" },
  { word: "chaud", cat: "adj", label: "un adjectif" },
  { word: "froid", cat: "adj", label: "un adjectif" },
  { word: "lourd", cat: "adj", label: "un adjectif" },
  { word: "léger", cat: "adj", label: "un adjectif" },
  { word: "propre", cat: "adj", label: "un adjectif" },
  { word: "sale", cat: "adj", label: "un adjectif" },
  { word: "nouveau", cat: "adj", label: "un adjectif" },
  { word: "vieux", cat: "adj", label: "un adjectif" },
  { word: "difficile", cat: "adj", label: "un adjectif" },
  { word: "facile", cat: "adj", label: "un adjectif" },

  // 20 ADVERBES (10%)
  { word: "doucement", cat: "adv", label: "un adverbe" },
  { word: "hier", cat: "adv", label: "un adverbe" },
  { word: "très", cat: "adv", label: "un adverbe" },
  { word: "souvent", cat: "adv", label: "un adverbe" },
  { word: "toujours", cat: "adv", label: "un adverbe" },
  { word: "demain", cat: "adv", label: "un adverbe" },
  { word: "bien", cat: "adv", label: "un adverbe" },
  { word: "mal", cat: "adv", label: "un adverbe" },
  { word: "trop", cat: "adv", label: "un adverbe" },
  { word: "peu", cat: "adv", label: "un adverbe" },
  { word: "beaucoup", cat: "adv", label: "un adverbe" },
  { word: "ici", cat: "adv", label: "un adverbe" },
  { word: "là", cat: "adv", label: "un adverbe" },
  { word: "aujourd'hui", cat: "adv", label: "un adverbe" },
  { word: "dehors", cat: "adv", label: "un adverbe" },
  { word: "dedans", cat: "adv", label: "un adverbe" },
  { word: "assez", cat: "adv", label: "un adverbe" },
  { word: "tard", cat: "adv", label: "un adverbe" },
  { word: "tôt", cat: "adv", label: "un adverbe" },
  { word: "maintenant", cat: "adv", label: "un adverbe" }
];

window.EXERCICES_VERBE_INFINITIF = [
  // 30 PHRASES AU PRESENT
  { phrase: "Noah mange sa tartine.", verb: "mange", inf: "manger", tense: "présent" },
  { phrase: "Le vent souffle fort.", verb: "souffle", inf: "souffler", tense: "présent" },
  { phrase: "Les oiseaux chantent le matin.", verb: "chantent", inf: "chanter", tense: "présent" },
  { phrase: "Nous lisons un livre intéressant.", verb: "lisons", inf: "lire", tense: "présent" },
  { phrase: "Tu finis tes devoirs à l'heure.", verb: "finis", inf: "finir", tense: "présent" },
  { phrase: "Je prépare un délicieux gâteau.", verb: "prépare", inf: "préparer", tense: "présent" },
  { phrase: "Le chien dort dans sa niche.", verb: "dort", inf: "dormir", tense: "présent" },
  { phrase: "Vous écoutez une belle mélodie.", verb: "écoutez", inf: "écouter", tense: "présent" },
  { phrase: "Le chat attrape une souris.", verb: "attrape", inf: "attraper", tense: "présent" },
  { phrase: "Les enfants jouent dans la cour.", verb: "jouent", inf: "jouer", tense: "présent" },
  { phrase: "Le jardinier arrose les fleurs.", verb: "arrose", inf: "arroser", tense: "présent" },
  { phrase: "Elle choisit une jolie robe.", verb: "choisit", inf: "choisir", tense: "présent" },
  ...
  { phrase: "Tu prends le bus tous les jours.", verb: "prends", inf: "prendre", tense: "présent" },
  { phrase: "Je bois un verre de lait.", verb: "bois", inf: "boire", tense: "présent" },
  { phrase: "Elle sourit à tout le monde.", verb: "sourit", inf: "sourire", tense: "présent" },
  { phrase: "Les élèves apprennent leurs leçons.", verb: "apprennent", inf: "apprendre", tense: "présent" },
  { phrase: "Le train arrive en gare.", verb: "arrive", inf: "arriver", tense: "présent" },
  { phrase: "Nous bâtissons un beau château.", verb: "bâtissons", inf: "bâtir", tense: "présent" },
  { phrase: "Tu ouvres la grande fenêtre.", verb: "ouvres", inf: "ouvrir", tense: "présent" },
  { phrase: "Le vent fait voler les feuilles.", verb: "fait", inf: "faire", tense: "présent" },
  { phrase: "Je dis toujours la vérité.", verb: "dis", inf: "dire", tense: "présent" },
  { phrase: "Ils courent vers la forêt.", verb: "courent", inf: "courir", tense: "présent" },
  { phrase: "Vous venez avec nous ce soir.", verb: "venez", inf: "venir", tense: "présent" },

  // 30 PHRASES A L'IMPARFAIT
  ...
  { phrase: "Vous écoutiez une belle mélodie.", verb: "écoutiez", inf: "écouter", tense: "imparfait" },
  { phrase: "Le chat attrapait une souris.", verb: "attrapait", inf: "attraper", tense: "imparfait" },
  { phrase: "Les enfants jouaient dans la cour.", verb: "jouaient", inf: "jouer", tense: "imparfait" },
  { phrase: "Le jardinier arrosait les fleurs.", verb: "arrosait", inf: "arroser", tense: "imparfait" },
  { phrase: "Elle choisissait une jolie robe.", verb: "choisissait", inf: "choisir", tense: "imparfait" },
  ...
  { phrase: "Tu prenais le bus tous les jours.", verb: "prenais", inf: "prendre", tense: "imparfait" },
  { phrase: "Je buvais un verre de lait.", verb: "buvais", inf: "boire", tense: "imparfait" },
  { phrase: "Elle souriait à tout le monde.", verb: "souriat", verb: "souriat", verb: "souriait", inf: "sourire", tense: "imparfait" },
  { phrase: "Les élèves apprenaient leurs leçons.", verb: "apprenaient", inf: "apprendre", tense: "imparfait" },
  { phrase: "Le train arrivait en gare.", verb: "arrivait", inf: "arriver", tense: "imparfait" },
  { phrase: "Nous bâtissions un beau château.", verb: "bâtissions", inf: "bâtir", tense: "imparfait" },
  { phrase: "Tu ouvrais la grande fenêtre.", verb: "ouvrais", inf: "ouvrir", tense: "imparfait" },
  { phrase: "Le vent faisait voler les feuilles.", verb: "faisait", inf: "faire", tense: "imparfait" },
  { phrase: "Je disais toujours la vérité.", verb: "disais", inf: "dire", tense: "imparfait" },
  { phrase: "Ils couraient vers la forêt.", verb: "couraient", inf: "courir", tense: "imparfait" },
  { phrase: "Vous veniez avec nous ce soir.", verb: "veniez", inf: "venir", tense: "imparfait" },

  // 30 PHRASES AU FUTUR SIMPLE
  { phrase: "Noah mangera sa tartine.", verb: "mangera", inf: "manger", tense: "futur simple" },
  { phrase: "Le vent soufflera fort.", verb: "soufflera", inf: "souffler", tense: "futur simple" },
  { phrase: "Les oiseaux chanteront le matin.", verb: "chanteront", inf: "chanter", tense: "futur simple" },
  { phrase: "Nous lirons un livre intéressant.", verb: "lirons", inf: "lire", tense: "futur simple" },
  { phrase: "Tu finiras tes devoirs à l'heure.", verb: "finiras", inf: "finir", tense: "futur simple" },
  { phrase: "Je préparerai un délicieux gâteau.", verb: "préparerai", inf: "préparer", tense: "futur simple" },
  { phrase: "Le chien dormira dans sa niche.", verb: "dormira", inf: "dormir", tense: "futur simple" },
  { phrase: "Vous écouterez une belle mélodie.", verb: "écouterez", inf: "écouter", tense: "futur simple" },
  { phrase: "Le chat attrapera une souris.", verb: "attrapera", inf: "attraper", tense: "futur simple" },
  { phrase: "Les enfants joueront dans la cour.", verb: "joueront", inf: "jouer", tense: "futur simple" },
  { phrase: "Le jardinier arrosera les fleurs.", verb: "arrosera", inf: "arroser", tense: "futur simple" },
  { phrase: "Elle choisira une jolie robe.", verb: "choisira", inf: "choisir", tense: "futur simple" },
  ...
  { phrase: "Tu prendras le bus tous les jours.", verb: "prendras", inf: "prendre", tense: "futur simple" },
  { phrase: "Je boirai un verre de lait.", verb: "boirai", inf: "boire", tense: "futur simple" },
  { phrase: "Elle sourira à tout le monde.", verb: "sourira", inf: "sourire", tense: "futur simple" },
  { phrase: "Les élèves apprendront leurs leçons.", verb: "apprendront", inf: "apprendre", tense: "futur simple" },
  { phrase: "Le train arrivera en gare.", verb: "arrivera", inf: "arriver", tense: "futur simple" },
  { phrase: "Nous bâtirons un beau château.", verb: "bâtirons", inf: "bâtir", tense: "futur simple" },
  { phrase: "Tu ouvriras la grande fenêtre.", verb: "ouvrirases", verb: "ouvrirons", verb: "ouvrirais", verb: "ouvrirras", verb: "ouvririras", verb: "ouvrirais", verb: "ouvrirras", verb: "ouvriras", inf: "ouvrir", tense: "futur simple" },
  { phrase: "Le vent fera voler les feuilles.", verb: "fera", inf: "faire", tense: "futur simple" },
  { phrase: "Je dirai toujours la vérité.", verb: "dirai", inf: "dire", tense: "futur simple" },
  { phrase: "Ils courront vers la forêt.", verb: "courront", inf: "courir", tense: "futur simple" },
  { phrase: "Vous viendrez avec nous ce soir.", verb: "viendrez", inf: "venir", tense: "futur simple" },

  // 10 PHRASES AU PASSE COMPOSE
  { phrase: "Noah a mangé sa tartine.", verb: "a mangé", inf: "manger", tense: "passé composé" },
  { phrase: "Le vent a soufflé fort.", verb: "a soufflé", inf: "souffler", tense: "passé composé" },
  { phrase: "Les oiseaux ont chanté le matin.", verb: "ont chanté", inf: "chanter", tense: "passé composé" },
  { phrase: "Nous avons lu un livre intéressant.", verb: "avons lu", inf: "lire", tense: "passé composé" },
  { phrase: "Tu as fini tes devoirs à l'heure.", verb: "as fini", inf: "finir", tense: "passé composé" },
  { phrase: "J'ai préparé un délicieux gâteau.", verb: "ai préparé", inf: "préparer", tense: "passé composé" },
  { phrase: "Le chien a dormi dans sa niche.", verb: "a dormi", inf: "dormir", tense: "passé composé" },
  { phrase: "Vous avez écouté une belle mélodie.", verb: "avez écouté", inf: "écouter", tense: "passé composé" },
  { phrase: "Le chat a attrapé une souris.", verb: "a attrapé", inf: "attraper", tense: "passé composé" },
