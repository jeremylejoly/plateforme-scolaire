...
window.EXERCICES_FRANCAIS = {
  ...
  conjugaison: {
    ...
    futur: {
      ...
      trous_bank: [
        {before:"Demain, nous", after:"visiter le musée avec toute la classe.", verb:"aller", answer:"irons"},
        {before:"L'année prochaine, il", after:"enfin son vélo tant désiré.", verb:"avoir", answer:"aura"},
        {before:"Dans dix ans, vous", after:"de grands professionnels.", verb:"être", answer:"serez"},
        {before:"Quand tu seras grand, tu", after:"tes études à l'université.", verb:"finir", answer:"finiras"},
        {before:"Dans quelques années, ils", after:"leurs talents pour créer une entreprise.", verb:"unir", answer:"uniront"},
        {before:"Bientôt, elle", after:"jouer du piano comme une vraie professionnelle.", verb:"savoir", answer:"saura"},
        {before:"L'année prochaine, ils", after:"participer au voyage scolaire en France.", verb:"pouvoir", answer:"pourront"},
        {before:"Ce soir, nous", after:"les ingrédients pour faire un gâteau au chocolat.", verb:"acheter", answer:"achèterons"},
        {before:"À la fin de l'année, vous", after:"vos vieux cahiers pour en prendre des neufs.", verb:"jeter", answer:"jetterez"},
        {before:"Dès qu'il rentrera, il", after:"ses parents pour les prévenir.", verb:"appeler", answer:"appellera"},
        {before:"Au printemps, l'eau", after:"à nouveau le long des sentiers de montagne.", verb:"ruisseler", answer:"ruissèlera"},
        {before:"Demain matin, vous", after:"les enfants chez le médecin.", verb:"emmener", answer:"emmènerez"},
        {before:"Quand il se réveillera, il", after:"les stores pour laisser entrer la lumière.", verb:"lever", answer:"lèvera"},
        {before:"Ce long voyage en voiture", after:"les plus jeunes enfants.", verb:"ennuyer", answer:"ennuiera"},
        {before:"Dans quelques années, cette région", after:"beaucoup plus de travailleurs.", verb:"employer", answer:"emploiera"},
        {before:"La semaine prochaine, vous", after:"vos dossiers à la nouvelle adresse.", verb:"envoyer", answer:"enverrez"},
        {before:"Après le repas, les enfants", after:"la vaisselle à tour de rôle.", verb:"essuyer", answer:"essuieront"},
        {before:"Dans quelques semaines, elle", after:"complètement de sa fracture.", verb:"guérir", answer:"guérira"},
        {before:"Cet été, ils", after:"au moins cinq livres pendant les vacances.", verb:"lire", answer:"liront"},
        {before:"Demain, vous", after:"la suite de votre histoire en classe de français.", verb:"écrire", answer:"écrirez"},
        {before:"Ce soir, nous", after:"le couvert pour accueillir nos invités.", verb:"mettre", answer:"mettrons"},
        {before:"Quand tu seras prêt, tu", after:"la vérité à tes parents.", verb:"dire", answer:"diras"},
        {before:"Ce week-end, ils", after:"une grande randonnée en montagne avec leurs amis.", verb:"faire", answer:"feront"},
        {before:"Pendant la fête, les invités", after:"du jus de fruits et de la limonade.", verb:"boire", answer:"boiront"},
        {before:"L'année prochaine, nous", after:"toutes les pièces de la maison.", verb:"peindre", answer:"peindrons"},
        {before:"Je suis sûr que tu ne", after:"plus jamais après cette leçon.", verb:"mentir", answer:"mentiras"},
        {before:"Vous", after:"votre rang pendant toute la cérémonie de remise des diplômes.", verb:"tenir", answer:"tiendrez"},
        {before:"Les parents", after:"les nouveaux élèves lors de la journée portes ouvertes.", verb:"accueillir", answer:"accueilleront"},
        {before:"Ce soir, vous", after:"sûrement goûter ce nouveau dessert.", verb:"vouloir", answer:"voudrez"},
        {before:"Dans quelques minutes, nous", after:"les résultats de notre évaluation.", verb:"recevoir", answer:"recevrons"},
        {before:"Bientôt, il", after:"de son long voyage en Australie.", verb:"revenir", answer:"reviendra"},
        {before:"L'année prochaine, ils", after:"changer d'école pour entrer au collège.", verb:"devoir", answer:"devront"},
        {before:"Pendant les vacances, vous", after:"enfin vos cousins que vous n'avez pas vus depuis longtemps.", verb:"voir", answer:"verrez"},
        {before:"Il", after:"partir très tôt demain matin pour attraper le train.", verb:"falloir", answer:"faudra"},
        {before:"Ensemble, vous", after:"ce problème difficile sans l'aide de personne.", verb:"résoudre", answer:"résoudrez"},
        {before:"Après l'école, nous", after:"nos amis au terrain de football.", verb:"rejoindre", answer:"rejoindrons"},
        {before:"Ce soir, elle", after:"sa petite sœur à son cours de danse.", verb:"amener", answer:"amènera"},
        {before:"Ils", after:"le froid cet hiver car leur chauffage est en panne.", verb:"craindre", answer:"craindront"},
        {before:"L'été prochain, elle", after:"son premier marathon.", verb:"courir", answer:"courra"},
        {before:"Pour les fêtes, ils", after:"nous rendre visite depuis l'autre bout du pays.", verb:"venir", answer:"viendront"},
        {before:"Sans eau ni soleil, cette fleur", after:"très rapidement.", verb:"mourir", answer:"mourra"},
        {before:"Pour le spectacle, vous", after:"vous-mêmes vos costumes de scène.", verb:"coudre", answer:"coudrez"},
        {before:"Après ses études, elle", after:"probablement à l'étranger.", verb:"vivre", answer:"vivra"},
        {before:"Dans quelques années, vous", after:"votre propre voiture.", verb:"conduire", answer:"conduirez"},
        {before:"Pendant la soirée, nous", after:"beaucoup en racontant nos souvenirs d'enfance.", verb:"rire", answer:"rirons"},
        {before:"Tout au long du voyage, ils", after:"scrupuleusement les conseils du guide.", verb:"suivre", answer:"suivront"},
        {before:"Dès le matin, vous", after:"les volets pour laisser entrer le soleil.", verb:"ouvrir", answer:"ouvrirez"},
        {before:"Pour l'anniversaire de leur mère, ils", after:"un beau bouquet de fleurs.", verb:"offrir", answer:"offriront"},
        {before:"Dès que tu auras fini tes devoirs, tu", after:"jouer avec tes amis.", verb:"sortir", answer:"sortiras"},
        {before:"Dans quelques instants, le soleil", after:"sur les sommets enneigés.", verb:"se lever", answer:"se lèvera"},ANCAIS[matiere][temps]
// ===================================================
